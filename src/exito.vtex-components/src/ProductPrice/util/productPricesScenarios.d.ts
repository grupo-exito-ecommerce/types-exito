 ...
 */
export declare const scenarioOne: (props: ProductPricesComponent, classesToUse: ComponentsClasses, showScenarios: boolean) => DistributionComponents[];
/**
 * Return the price with the next scenarios
...
export declare const scenarioMKPI: (props: ProductPricesComponent, classesToUse: ComponentsClasses, showScenarios: boolean) => DistributionComponents[];
/**
